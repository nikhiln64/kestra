...
public class V2_0_18LocksTenantIdMigration extends AbstractSQLMigrationScript {
    ...
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.18-locks-tenant-id-h2.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.18-locks-tenant-id-h2.sql");
    }
}
