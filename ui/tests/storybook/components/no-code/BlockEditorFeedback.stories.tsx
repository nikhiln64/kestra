...
export const F3DeeplyNestedFlowables: Story = {
    ...
    play: async ({canvasElement}) => {
        ...
        const innerHeader = [...canvasElement.querySelectorAll("[data-test='flowable-cluster-header']")]
            .find(el => within(el as HTMLElement).queryByText("check_customer_impact")) as HTMLElement
