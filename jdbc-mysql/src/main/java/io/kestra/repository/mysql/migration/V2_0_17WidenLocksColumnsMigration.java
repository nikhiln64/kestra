...
public class V2_0_17WidenLocksColumnsMigration extends AbstractSQLMigrationScript {
    ...
    public String checksum() {
        return MigrationScript.checksumOfResources("/migrations/2.0.17-widen-locks-mysql.sql");
    }

    @Override
    public void migrate() throws Exception {
        executeSqlResource(dataSource, "/migrations/2.0.17-widen-locks-mysql.sql");
    }
}
